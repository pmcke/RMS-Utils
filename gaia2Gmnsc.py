""" 
Usage python gaia2Gmnsc.py <directory_path>
Writen by Peter McKellar with help from Chat GPT
This looks for .config files in a directory and below, then changes the star_catalog line from gaia to GMN_StarCatalog
"""
            ...
            with open(config_file, "r+") as f:
                ...
                for line in lines:
                    ...
                    if line.strip() == 'star_catalog_file: gaia_dr2_mag_11.5.npy':
                        line = 'star_catalog_file: GMN_StarCatalog\n'  # Modify the line
